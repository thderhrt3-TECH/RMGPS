        ...
        <div className="flex justify-between items-center h-20">
          <Link to="/" className="flex items-center space-x-3 flex-shrink-0">
            ...
            <div className="flex flex-col min-w-0">
              <span className="text-lg font-bold text-red-600 truncate">Rocky Mountain GPS</span>
            </div>
          </Link>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div className="md:col-span-1">
            ...
            <h3 className="text-xl font-bold mb-4 text-red-600">Rocky Mountain GPS</h3>
        ...
        <div className="text-center text-gray-400 border-t border-gray-800 pt-8">
          <p>&copy; 2025 <span className="text-red-600">Rocky Mountain Global Peace & Sports Complex</span>. All rights reserved.</p>
          <p className="text-sm mt-3 max-w-4xl mx-auto">
            <span className="text-red-600">Rocky Mountain Global Peace & Sports Complex (Rocky Mountain GPS)</span> is a registered nonprofit in the State of Utah, doing business under the auspices of <em>thunder</em>Heart, Inc. A 501(c)(3) non-for-profit that has been registered with the Internal Revenue Service (IRS) since 2005.
          </p>
