          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <article className="bg-gray-900 border-2 border-gray-700 rounded-lg overflow-hidden hover:shadow-xl hover:border-white transition">
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold text-white mb-3">Complex Construction Update</h3>
            ...
            <article className="bg-gray-900 border-2 border-gray-700 rounded-lg overflow-hidden hover:shadow-xl hover:border-white transition">
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold text-white mb-3">Youth Program Launch</h3>
                <p className="text-gray-300 mb-4">
            ...
            <article className="bg-gray-900 border-2 border-gray-700 rounded-lg overflow-hidden hover:shadow-xl hover:border-white transition">
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold text-white mb-3">Community Partnership</h3>
                <p className="text-gray-300 mb-4">
