...
const Programs = () => {
  return (
    <div className="programs-page">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-blue-600 to-blue-800 text-white py-20" data-testid="programs-hero">
      ...
      <section className="py-20 bg-white" data-testid="sports-programs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white border-2 border-gray-200 p-8 rounded-lg hover:shadow-xl transition" data-testid="program-ice-hockey">
              <h3 className="text-2xl font-bold text-blue-600 mb-4">Ice Hockey</h3>
            ...
            <div className="bg-white border-2 border-gray-200 p-8 rounded-lg hover:shadow-xl transition" data-testid="program-basketball">
              <h3 className="text-2xl font-bold text-blue-600 mb-4">Basketball</h3>
              <p className="text-gray-700 mb-4">
            ...
            <div className="bg-white border-2 border-gray-200 p-8 rounded-lg hover:shadow-xl transition" data-testid="program-soccer">
              <h3 className="text-2xl font-bold text-blue-600 mb-4">Soccer</h3>
              <p className="text-gray-700 mb-4">
            ...
            <div className="bg-white border-2 border-gray-200 p-8 rounded-lg hover:shadow-xl transition" data-testid="program-baseball">
              <h3 className="text-2xl font-bold text-blue-600 mb-4">Baseball/Softball</h3>
              <p className="text-gray-700 mb-4">
            ...
            <div className="bg-white border-2 border-gray-200 p-8 rounded-lg hover:shadow-xl transition" data-testid="program-football">
              <h3 className="text-2xl font-bold text-blue-600 mb-4">Football</h3>
              <p className="text-gray-700 mb-4">
            ...
            <div className="bg-white border-2 border-gray-200 p-8 rounded-lg hover:shadow-xl transition" data-testid="program-equestrian">
              <h3 className="text-2xl font-bold text-blue-600 mb-4">Equestrian</h3>
              <p className="text-gray-700 mb-4">
      ...
      <section className="py-20 bg-gray-50" data-testid="educational-programs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md" data-testid="program-charter-school">
              <h3 className="text-2xl font-bold text-blue-600 mb-4">Charter School</h3>
              <p className="text-gray-700 mb-4">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md" data-testid="program-mentorship">
              <h3 className="text-2xl font-bold text-blue-600 mb-4">Mentorship Programs</h3>
              <p className="text-gray-700 mb-4">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md" data-testid="program-environmental">
              <h3 className="text-2xl font-bold text-blue-600 mb-4">Environmental Stewardship</h3>
              <p className="text-gray-700 mb-4">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md" data-testid="program-music">
              <h3 className="text-2xl font-bold text-blue-600 mb-4">Music & Arts</h3>
              <p className="text-gray-700 mb-4">
      ...
      {/* CTA Section */}
      <section className="py-20 bg-blue-600 text-white" data-testid="programs-cta">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
